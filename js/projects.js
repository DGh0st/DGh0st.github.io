...
var iosprojects = [
            ...
            '<div class = "tweak-hidden"><h3>AppSwitcherCurrentOrig</h3><img src="img/AppSwitchCurent.gif"><br><a href="https://www.github.com/DGh0st/AppSwitchCurrentOrig">GitHub</a><center><h5>Opens the app switcher to the current application instead of the last application. Official version is named AppSwitcherCurrent.</h5><h5>Repo: <a href="http://moreinfo.thebigboss.org/moreinfo/depiction.php?file=appswitchcurrentDp">BigBoss (iOS 8)</a>, <a href="http://moreinfo.thebigboss.org/moreinfo/depiction.php?file=appswitchcurrent10Dp">BigBoss (iOS 9 &amp; 10)</a>, <a href="https://dgh0st.github.io/Files/?p=com.dgh0st.appswitchcurrentOrig">DGh0st Beta Repo</a></h5></center></div>',
            '<div class = "tweak-hidden"><h3>BadgeOverlay</h3><img src="img/BadgeOverlay.png"><br><a href="https://www.github.com/DGh0st/BadgeOverlay">GitHub</a><center><h5>Make badges overlay on top of icons instead of being in the corner. Give badges a more sleek look by making them overlays.</h5><h5>Repo: <a href="https://dgh0st.github.io/Files/?p=com.dgh0st.badgeoverlay">DGh0st Beta Repo</a></h5></center></div>',
            ...
            '<div class = "tweak-hidden"><h3>LSScreenshotLimit</h3><img src="img/LSScreenshotLimit.png"><br><a href="https://www.github.com/DGh0st/LSScreenshotLimit">GitHub</a><center><h5>Limit the amount of screenshots that can be taken on the lockscreen with ability to fake screenshots.</h5><h5>Repo: <a href="http://moreinfo.thebigboss.org/moreinfo/depiction.php?file=lsscreenshotlimitDp">BigBoss</a>, <a href="https://dgh0st.github.io/Files/?p=com.dgh0st.lsscreenshotlimit">DGh0st Beta Repo</a></h5></center></div>',
            '<div class = "tweak-hidden"><h3>NCAlwaysChevron</h3><img src="img/NCAlwaysChevron.png"><br><a href="https://www.github.com/DGh0st/NCAlwaysChevron">GitHub</a><center><h5>Always display the chevron view in the notification center instead of switching to page dots once notfication center is fully displayed.</h5><h5>Repo: <a href="https://dgh0st.github.io/Files/?p=com.dgh0st.ncalwayschevron">DGh0st Beta Repo</a></h5></center></div>',
            ...
            '<div class = "tweak-hidden"><h3>ScreenshotXI</h3><img src="img/ScreenshotXI.png"><br><a href="https://www.github.com/DGh0st/ScreenshotXI">GitHub</a><center><h5>Brings iOS 11 style screenshotting to iOS 9 and 10 with ability to easily share and edit screenshots on the go.</h5><h5>Repo: <a href="http://moreinfo.thebigboss.org/moreinfo/depiction.php?file=screenshotxiDp">BigBoss ($1.00)</a></h5></center></div>',
...
function changeWeek(week) {
	document.getElementById("weekChallenge").innerHTML = weeksDivs[week];
